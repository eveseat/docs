...
| [humunuk/alliance-structure-mngmt](https://github.com/humunuk/alliance-structure-mngmt) | [![Latest Stable Version](https://poser.pugx.org/humunuk/alliance-structure-mngmt/v/stable?format=flat-square)](https://packagist.org/humunuk/alliance-structure-mngmt) | Add "Structures" sub-menu to Alliance page and show all the structures that belong to corps in alliance |
