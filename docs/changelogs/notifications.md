...
### 3.0.2
```
d9d7cba		build(core): v3.0.2
5ab4330		[feat](core): Use new migration mechanic
453d3d9		[feat](dependencies): Update DataTables Dependencies for new DataTables Version (#16)
9488d92		fix(token state): Remove deprecated apikey routes references (#15)
e460ffb		v3.0.1
8d03240		remove eve from available notification type (#13)
6a0f85a		fix new token mail notification route (#12)
756fdd8		v3.0.0 🎉
6abd598		v3.0.0-beta3
b198e42		Apply fixes from StyleCI (#11)
a2847c6		Revive notifications.
4c8186c		v3.0.0-beta2
b003788		Upgrade packages and version 3.0.0-beta1
75b69af		Indentation and sorting fixes.
ea8775a		Fix affiliations-panel (#9)
181e7ee		Apply fixes from StyleCI (#8)
```
